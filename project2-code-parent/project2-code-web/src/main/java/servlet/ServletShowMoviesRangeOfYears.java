...
@WebServlet("/ShowMoviesRangeOfYears")
public class ServletShowMoviesRangeOfYears extends HttpServlet {
    @EJB
    movieS movie;
    @EJB
    userServices check;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if((boolean)request.getSession().getAttribute("loggedIn")){
            ...
            List<movieDTO> movies = movie.printByRangeOfYear(Integer.parseInt(request.getParameter("year1")),Integer.parseInt(request.getParameter("year2")),Integer.parseInt(request.getParameter("Option")));
            ...
            out.println("<br><a href=\"menuSearchRangerOfYears.jsp\">Voltar ao Menu Search Within a Range of Years</a>");
            ...
            out.println("window.location.href = \"menuSearchRangerOfYears.jsp\"");
            out.println("</script>");
        }
