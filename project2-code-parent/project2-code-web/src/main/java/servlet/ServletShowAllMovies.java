...
@WebServlet("/ShowAllMovies")
public class ServletShowAllMovies extends HttpServlet {
    @EJB
    movieS movie;
    @EJB
    userServices check;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if((boolean)request.getSession().getAttribute("loggedIn")){
            ...
            List<movieDTO> movies = movie.getAllContent(Integer.parseInt(request.getParameter("Option")));
            ...
            out.println("<br><a href=\"menuSearchAllMovie.jsp\">Voltar ao Menu Search All</a>");
