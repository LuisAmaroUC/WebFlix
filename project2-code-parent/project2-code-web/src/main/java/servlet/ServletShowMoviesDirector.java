...
@WebServlet("/ShowMoviesDirector")
public class ServletShowMoviesDirector extends HttpServlet {
    @EJB
    movieS movie;
    @EJB
    userServices check;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if((boolean)request.getSession().getAttribute("loggedIn")){
            ...
            List<movieDTO> movies = movie.printByDirector(request.getParameter("Director"),Integer.parseInt(request.getParameter("Option")));
            ...
            out.println("<br><a href=\"menuSerachMoviesDirector.jsp\">Voltar ao Menu Search By Director</a>");
